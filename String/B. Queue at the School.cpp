...
However, after a while the boys started feeling awkward for standing in front of the girls in the queue
and they started letting the girls move forward each second.
...
The next line contains string s, which represents the school children's initial arrangement.
